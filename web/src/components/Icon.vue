<template>
  ...
  >
    ...
    <template v-else-if="name === 'list-filter'">
      <path d="M3 6h18" />
      <path d="M7 12h10" />
      <path d="M10 18h4" />
    </template>
    ...
    <path v-else-if="name === 'moon'" d="M21 12.8A8.5 8.5 0 1 1 11.2 3 6.6 6.6 0 0 0 21 12.8z" />
    ...
    <template v-else-if="name === 'cloud'">
      <path d="M17.5 19H6a4 4 0 0 1-.4-8A6.5 6.5 0 0 1 18.2 9a5 5 0 0 1-.7 10z" />
    </template>
    <template v-else-if="name === 'gauge'">
      <path d="M4.9 19a9 9 0 1 1 14.2 0" />
      <path d="m12 13 4-4" />
      <line x1="12" y1="4" x2="12" y2="6" />
      <line x1="5.6" y1="8" x2="7.3" y2="9" />
      <line x1="18.4" y1="8" x2="16.7" y2="9" />
    </template>
...
withDefaults(defineProps<{ name: string; size?: number | string; strokeWidth?: number }>(), {
  size: 14,
  strokeWidth: 2,
});
</script>
