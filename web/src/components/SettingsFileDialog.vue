  ...
  <Teleport to="body">
    <Transition name="fade" appear>
      <div class="editor-overlay" @click.self="requestClose">
        <div class="editor-dialog" role="dialog" aria-modal="true" :aria-label="t('settings.fileTitle')">
          <header class="editor-head">
            <span class="editor-name">{{ t("settings.fileTitle") }}</span>
            <span class="editor-hint">{{ t("settings.fileHint") }}</span>
