...
describe("daemon HTTP route matching", () => {
  ...
  it("matches every namespaced route with its auth class", () => {
    const cases: Array<[string, string, string]> = [
      ...
      ["POST", "/sash/core/update", "control"],
      ["PUT", "/sash/core/mode", "control"],
      ["GET", "/sash/proxy", "public"],
      ["GET", "/sash/settings", "control"],
      ["PATCH", "/sash/settings", "control"],
      ["GET", "/sash/autostart", "control"],
      ["PUT", "/sash/autostart", "control"],
      ["PUT", "/sash/profiles/order", "control"],
      ["GET", "/sash/profiles", "control"],
      ["POST", "/sash/profiles", "control"],
      ["POST", "/sash/web/bootstrap", "control"],
      ["POST", "/sash/web/session", "public"],
